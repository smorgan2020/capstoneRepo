...
LaunchSites.sort()
siteDropdownOptions =[]
siteDropdownOptions.append({'label': 'All Sites', 'value': 'ALL'})
for i in range(len(LaunchSites)):
    siteDropdownOptions.append({'label': LaunchSites[i], 'value': LaunchSites[i]})
...
def get_pie_chart(entered_site):
    ...
    if entered_site == 'ALL':
        ...
        names='class',
        title='Launch Success Ratio at Site ' + entered_site)
        return fig
